/*:
 ...
 Our apps have pieces of user's information in them. We tend to refer to this information as "data" or "model objects". In a Todo app this may be a single `TodoItem`, or an collection of items in a `TodoList`.
